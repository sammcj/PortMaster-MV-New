...
GAMEDIR=/$directory/ports/megamanw/
...
#Renames any .pck file to the correct file name
[ -f mmw.pck ] || mv -f *.pck mmw.pck
...
$GPTOKEYB "$runtime" -c "./mmw.gptk" &
pm_platform_helper "$godot_dir/$runtime"
"$runtime" $GODOT_OPTS --main-pack "mmw.pck"
